...
draft = false
+++
- [09/2024] One paper on <a href="https://arxiv.org/pdf/2402.04437" target="_blank">knowledge extraction using LLMs</a> has been accepted by **EMNLP 2024** main conference.
- [09/2024] One survey paper on <a href="https://arxiv.org/pdf/2402.04437" target="_blank">using LLMs for telecommunications</a> has been accepted by **IEEE Communications Surveys and Tutorials 2024** (impact factor: 35.6). 
- [07/2024] One paper on <a href="https://arxiv.org/pdf/2405.09369" target="_blank">diffusion-based contrastive learning for sequential recommendation</a> has been accepted by **CIKM 2024**.
- [06/2024] One theoretical paper on <a href="https://arxiv.org/pdf/2404.17313" target="_blank">group-aware search success</a> is accepted by **SIGIR ICTIR 2024**.
- [04/2024] I am ranked in the **1st-place** for the prestigious doctoral research scholarship by the **Fonds de recherche du Québec – Nature et Technologies (FRQNT)** 🎉.
- [03/2024] One survey paper on <a href="https://arxiv.org/pdf/2212.14464" target="_blank">diversity in search and recommendation</a> is accepted by **TKDE 2024**.
- [01/2024] One interdisciplinary collaboration on <a href="https://arxiv.org/pdf/2401.12956" target="_blank">using linguistic features to reveal learners’ psychological patterns</a> accepted by **CHI 2024**. Look forward to visiting Hawaii 🏖!
